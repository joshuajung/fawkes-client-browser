...
export interface AdvancedRecordListLoadRequestEnded extends ApiRequestEndedEvent {
    type: EventType.AdvancedRecordListLoadRequestEnded;
}
export interface AdvancedRecordListLoadRequestStarted extends ApiRequestStartedEvent {
    type: EventType.AdvancedRecordListLoadRequestStarted;
}
export interface AdvancedRecordDetailsUpdateRequestEnded extends ApiRequestEndedEvent {
    type: EventType.AdvancedRecordDetailsUpdateRequestEnded;
}
export interface AdvancedRecordDetailsUpdateRequestStarted extends ApiRequestStartedEvent {
    type: EventType.AdvancedRecordDetailsUpdateRequestStarted;
}
export interface AdvancedRecordDetailsSelectRequestEnded extends ApiRequestEndedEvent {
    type: EventType.AdvancedRecordDetailsSelectRequestEnded;
}
export interface AdvancedRecordDetailsSelectRequestStarted extends ApiRequestStartedEvent {
