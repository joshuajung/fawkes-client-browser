    ...
    render() {
        ...
        return (React.createElement("div", { className: "field" },
            ...
            React.createElement("div", { className: this.controlClasses() },
                React.createElement("input", Object.assign({}, this.inputProps(), { id: inputId, value: this.props.value.toInput(), placeholder: this.props.placeholder, readOnly: true })),
                this.infoIcon())));
    }
}
const stateMappings = (s, props) => ({});
const dispatchMappings = (d, props) => ({});
exports.default = (() => ce.enhance(AdvancedFormInputReadonly, { stateMappings, dispatchMappings }))();
//# sourceMappingURL=advancedFormInputReadonly.js.map